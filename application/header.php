...
.loading-spinner {
    ...
    border: 5px solid #333; border-top-color: red;
    border-radius: 50%; animation: spin 0.8s linear infinite;
}
@keyframes spin { to { transform: rotate(360deg); } }
.loading-texto {
    font-family: "Josefin Sans", sans-serif;
    font-size: 1.1vw; color: #ccc; margin: 0; letter-spacing: 0.05em;
}
.header-usuario {
    font-family: "Josefin Sans", sans-serif;
    font-size: 0.85vw; color: #aaa; white-space: nowrap;
    text-decoration: none; transition: color 0.2s; flex-shrink: 0;
}
.header-usuario:hover { color: white; }
.icone-usuario {
    height: 1.4vw; width: auto; vertical-align: middle;
    opacity: 0.7; transition: opacity 0.2s;
}
.header-usuario:hover .icone-usuario { opacity: 1; }
.header-auth-link {
    font-family: "Josefin Sans", sans-serif; font-size: 0.85vw;
...
.header-auth-btn {
    font-family: "Josefin Sans", sans-serif; font-size: 0.8vw;
    color: white; background: red; text-decoration: none;
    padding: 0.35em 0.9em; border-radius: 6px; transition: background 0.2s;
    white-space: nowrap; flex-shrink: 0; margin-left: 0;
}
