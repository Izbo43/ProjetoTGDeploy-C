...
.loading-texto {
    ...
    font-size: 1.1vw; color: #ccc;
    margin: 0; letter-spacing: 0.05em;
}
.header-usuario {
    font-family: "Josefin Sans", sans-serif;
    font-size: 0.85vw; color: #aaa;
    white-space: nowrap; text-decoration: none; transition: color 0.2s; flex-shrink: 0;
}
.header-usuario:hover { color: white; }
.icone-usuario {
    height: 1.4vw; width: auto;
    vertical-align: middle; opacity: 0.7; transition: opacity 0.2s;
}
.header-usuario:hover .icone-usuario { opacity: 1; }
.header-auth-link {
    font-family: "Josefin Sans", sans-serif;
    font-size: 0.85vw; color: #ccc;
...
.header-auth-btn {
    font-family: "Josefin Sans", sans-serif;
    font-size: 0.8vw; color: white; background: red;
    text-decoration: none; padding: 0.35em 0.9em;
